<div class="pointer-events-none fixed bottom-4 left-4 z-40 print:hidden">
    <div class="inline-flex items-center gap-2 rounded-full border border-slate-200/90 bg-white/88 px-3 py-2 shadow-[0_10px_30px_rgba(15,35,53,0.10)] backdrop-blur">
