            ...
            <form method="POST" action="{{ route('portal.tickets.store') }}" class="panel-card p-4">
                ...
                <div class="mt-3 space-y-3">
                    <div>
                        ...
                        <input name="assunto" placeholder="Ex: Dúvida sobre documentação" class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm" required>
                    </div>

                    <div>
                        <label class="mb-1 block text-sm font-semibold text-slate-700">Mensagem inicial</label>
                        <textarea name="mensagem" rows="4" placeholder="Descreva sua necessidade..." class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm"></textarea>
                    </div>
